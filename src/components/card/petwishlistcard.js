...
export default function PetWishListCard({p,user,handlepetlove,removePet,token}) {
  ...
  return (
    <Card className={classes.root}  >
      <CardHeader
        ...
        // }
        action={
            <i onClick={()=>removePet(token,p._id,petname)} style={{cursor:'pointer'}} class="fas fa-trash-alt"></i>
        }
      ...
      <CardActions disableSpacing>
        ...
        <Button onClick={handleMoreInfo} variant="contained">Adopt Me</Button>
