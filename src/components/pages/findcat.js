      ...
      <div className="row">
              ...
              <div>
                ...
                >
                  ...
                  <Option value="Calico" label="Calico">
                    <div className="demo-option-label-item">Calico</div>
                  </Option>
                </Select>
              </div>
            </SubMenu>
              ...
              <div>
                ...
                >
                  <Option value="Kitten" label="Kitten">
                    <div className="demo-option-label-item">Kitten</div>
                  </Option>
                  <Option value="Young" label="Young">
                    <div className="demo-option-label-item">Young</div>
                  </Option>
                  <Option value="Adult" label="Adult">
                    <div className="demo-option-label-item">Adult</div>
                  </Option>
                  <Option value="Senior" label="Senior">
                    <div className="demo-option-label-item">Senior</div>
                  </Option>
                </Select>
              </div>
            </SubMenu>
              ...
              <div>
                ...
                >
                  <Option value="Hairless" label="Hairless">
                    <div className="demo-option-label-item">Hairless</div>
                  </Option>
                  <Option value="Short" label="Short">
                    <div className="demo-option-label-item">Short</div>
                  </Option>
                  <Option value="Medium" label="Medium">
                    <div className="demo-option-label-item">Medium</div>
                  </Option>
                  <Option value="Long" label="Long">
                    <div className="demo-option-label-item">Long</div>
                  </Option>
                </Select>
              </div>
            </SubMenu>
              ...
              <div>
                ...
                >
                  ...
                  <Option value="Brown" label="Brown">
                    <div className="demo-option-label-item">Brown</div>
                  </Option>
                  <Option value="Black&White" label="Black&White">
                    <div className="demo-option-label-item">Black&White</div>
                  </Option>
                  <Option value="Gray&White" label="Gray&White">
                    <div className="demo-option-label-item">Gray & White</div>
                  </Option>
                  <Option value="Gray" label="Gray">
                    <div className="demo-option-label-item">Gray</div>
                  </Option>
                </Select>
              </div>
            </SubMenu>
        ...
        <div className="col  pt-2">
          {loading ? (
            ...
            <h4 className="text-danger">Pets</h4>
          )}
