            ...
            <div className="row">
                ...
                <div className="col-md-6 offset-md-3">
                 ...
                 <form onSubmit={handleSubmit}>
                    ...
                    <center> <Button type="default" className="mb-3" onClick={facebooklogin} block shape="round" icon={<FacebookOutlined />} size="large" >Login With Facebook </Button></center> 

                        <Link to='/forgetpass' className="float-right text-danger"> Forgot Password ?</Link> <br></br>
                        <Link to='/sign-up' className="float-right text-blue"> Create an Account</Link>
                    </form>
